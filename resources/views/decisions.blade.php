    ...
    <main class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-3 gap-8">
            ...
            <div class="col-span-2 bg-white shadow-md rounded p-6">
                <h1 class="text-2xl font-bold text-gray-700 mb-4">Teams / Matches</h1>
                <p class="text-gray-600 mb-6">a choice for you to see matches or teams.</p>
                <div class="flex space-x-4">
                    <a href="{{route('matches')}}" class="flex-1 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 text-center">Matches</a>
