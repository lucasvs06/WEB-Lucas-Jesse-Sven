<x-base-layout>
    <form action="{{route('match.store')}}" method="POST" class="max-w-md mx-auto bg-white p-6 rounded shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="field" name="field" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" id="time" name="time" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
