<x-base-layout>
    <form action="{{ route('teams.update', $team->id) }}" method="POST" class="max-w-md mx-auto bg-white p-6 rounded shadow-md">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300" value="{{ $team->name }}" required>
        </div>

        <div class="mb-4">
            <label for="school" class="block text-gray-700 font-semibold mb-2">School</label>
            <input type="text" id="school" name="school" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300" value="{{ $team->school }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="members" name="members" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300" min="0" value="{{ $team->members }}" required>
        </div>
